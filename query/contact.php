    ...
    <body>
        ...
        <div class="col-sm-12" >
            ...
            <div class="col-sm-4 about-me">
                <h1 style="letter-spacing: 10px"class="animated bounce">MESSAGES</h1>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <fieldset>
                            ...
                            <span class="message__time"><span style="color:blue">Email:</span><?php echo $row['email']; ?></span><br/>
                            <span class="message__time"><span style="color:blue">Website:</span><?php echo $row['website']; ?></span>
                           </div>
                        </fieldset>
                    <?php } ?>
                    <?php
