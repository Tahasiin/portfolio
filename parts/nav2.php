    ...
    <div class="uk-navbar-right nav-overlay" >
        <div class="uk-navbar-flip">
            <ul class="uk-navbar-nav uk-visible@s">
                ...
                <li><a class="a" href="../download.php"><span id="downloads-nav">Downloads</span></a></li>
...
<div id="mobile-navbar" uk-offcanvas="mode: slide; flip: false">
    <div class="uk-offcanvas-bar">
        ...
        <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
            ...
            <li><a id="url" href=""><span uk-icon="sign-in" class="access-sidenav" style="color:#cccccc"></span></a></li>
        </ul>
    </div>
</div>